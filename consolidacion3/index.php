...
<body background="images/golf.jpg" style="background-attachment: fixed" >
	...
	<table border="0" align="center" valign="middle">
		...
		<tr><td><label style="font-size: 14pt"><b>Contraseña: </b></label></td>
			<td witdh=80><input style="border-radius:15px;" type="password" name="pass"  minlength="5" maxlength="10"/></td></tr>
		<tr><td></td>
...
<form method="post" action="" >
  <fieldset>
    ...
    <div class="form-group">
      ...
      <input type="password" name="pass" class="form-control"  placeholder="Ingresa contraseña"   minlength="5"  maxlength="10"/>
    </div>
    <div class="form-group">
      <label style="font-size: 14pt"><b>Repite tu contraseña</b></label>
      <input type="password" name="rpass" class="form-control" required placeholder="repite contraseña"  minlength="5"  maxlength="10"/>
    </div>
